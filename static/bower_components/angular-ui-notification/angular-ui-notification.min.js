...
angular.module("ui-notification").provider("Notification",
function () {
    ...
    this.$get = function ($timeout, uiNotificationTemplates, $http, $compile, $templateCache, $rootScope, $injector, $sce, $q,$window) {
        ...
        var notify = function (args, t) {
            ...
            $http.get(args.template, { cache: $templateCache }).success(function (template) {
                ...
                templateElement.bind('webkitTransitionEnd oTransitionEnd otransitionend transitionend MSTransitionEnd msTransitionEnd click', function (e) {
                    e = e.originalEvent || e;
